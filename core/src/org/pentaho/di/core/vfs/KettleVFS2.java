...
import org.pentaho.di.core.vfs.configuration.IKettleFileSystemConfigBuilder2;
import org.pentaho.di.core.vfs.configuration.KettleFileSystemConfigBuilderFactory2;
import org.pentaho.di.i18n.BaseMessages;

public class KettleVFS2 {
  private static Class<?> PKG = KettleVFS2.class; // for i18n purposes, needed by Translator2!!

  private static final KettleVFS2 kettleVFS = new KettleVFS2();
  ...
  public static KettleVFS2 getInstance() {
    return kettleVFS;
  }
  ...
  private static FileSystemOptions buildFsOptions( VariableSpace varSpace, FileSystemOptions sourceOptions,
    ...
    IKettleFileSystemConfigBuilder2 configBuilder =
      KettleFileSystemConfigBuilderFactory2.getConfigBuilder( varSpace, scheme );

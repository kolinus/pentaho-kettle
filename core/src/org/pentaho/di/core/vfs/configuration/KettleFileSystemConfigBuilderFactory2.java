 ...
 * @author cboyden
 */
public class KettleFileSystemConfigBuilderFactory2 {

  private static Class<?> PKG = KettleVFS2.class; // for i18n purposes, needed by Translator2!!
   ...
   * @throws IOException
   */
  public static IKettleFileSystemConfigBuilder2 getConfigBuilder( VariableSpace varSpace, String scheme ) throws IOException {
    IKettleFileSystemConfigBuilder2 result = null;
    ...
    if ( parserClass != null ) {
      try {
        ...
        if ( ( mGetInstance != null )
          ...
          result = (IKettleFileSystemConfigBuilder2) mGetInstance.invoke( null );
        } else {
          result = (IKettleFileSystemConfigBuilder2) configBuilderClass.newInstance();
        }
      } catch ( Exception e ) {
      ...
      if ( scheme.equalsIgnoreCase( "sftp" ) ) {
        result = KettleSftpFileSystemConfigBuilder2.getInstance();
      } else {
        result = KettleGenericFileSystemConfigBuilder2.getInstance();
      }
    }

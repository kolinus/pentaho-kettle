 ...
 * @author cboyden
 */
public class KettleGenericFileSystemConfigBuilder2 extends FileSystemConfigBuilder implements
  IKettleFileSystemConfigBuilder2 {

  private static final KettleGenericFileSystemConfigBuilder2 builder = new KettleGenericFileSystemConfigBuilder2();
  ...
  public static KettleGenericFileSystemConfigBuilder2 getInstance() {
    return builder;
  }
  ...
  protected KettleGenericFileSystemConfigBuilder2() {
    super();
  }

  abstract static class KettleDefaultFileSystem2 implements FileSystem {
  }

  @Override
  protected Class<? extends FileSystem> getConfigClass() {
    return KettleDefaultFileSystem2.class;
  }
  ...
  public void setParameter( FileSystemOptions opts, String name, String value, String fullParameterName,
    ...
    try {
      DelegatingFileSystemOptionsBuilder delegateFSOptionsBuilder =
        new DelegatingFileSystemOptionsBuilder( KettleVFS2.getInstance().getFileSystemManager() );
      if ( scheme != null ) {

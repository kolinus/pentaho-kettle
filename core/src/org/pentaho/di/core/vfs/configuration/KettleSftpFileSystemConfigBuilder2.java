 ...
 * @author cboyden
 */
public class KettleSftpFileSystemConfigBuilder2 extends KettleGenericFileSystemConfigBuilder2 {

  private static final KettleSftpFileSystemConfigBuilder2 builder = new KettleSftpFileSystemConfigBuilder2();
  private static final LogChannelInterface log = new LogChannel( "cfgbuilder" );

  public static KettleSftpFileSystemConfigBuilder2 getInstance() {
    return builder;
  }

  protected KettleSftpFileSystemConfigBuilder2() {
    super();
  }
